                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            ...
                            <div class="small-muted"><?= esc($product['product_code']) ?> • <?= format_kg($product['weight_kg']) ?></div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="summary-number"><?= $product['current_price'] !== null ? format_rupiah($product['current_price']) : 'Belum diatur' ?></div>
                    </div>
                    ...
                    <form action="<?= site_url('/admin/prices/update/' . $product['id']) ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="effective_date" class="form-control" value="<?= esc(date('Y-m-d')) ?>" required>
                        </div>
                ...
                <?php else: ?>
                    <?php foreach ($priceHistory as $history): ?>
                        <tr>
                            ...
                            <td><?= esc(date('d-m-Y', strtotime((string) $history['effective_date']))) ?></td>
