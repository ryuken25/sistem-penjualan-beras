                    ...
                    <div>
                        ...
                        <div class="page-subtitle">
                            <?= $isTemplateMode
                                ...
                                : 'Masukkan jumlah qty untuk kemasan 5 kg, 10 kg, dan 25 kg. Sistem menghitung total secara otomatis.' ?>
                        </div>
                    </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <div class="small-muted">Pilih salah satu template aktif. Qty akan terisi otomatis
                                        sesuai template.</div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 bg-light-subtle mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                <div>
                                    <h3 class="h5 mb-1">Input Qty Kemasan Beras</h3>
                                    <div class="small-muted">Isi qty masing-masing kemasan. Minimal satu qty harus lebih
                                        dari 0.</div>
                                </div>
                            </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    <div class="small-muted">Total Qty</div>
        ...
        <?php if (!$isTemplateMode): ?>
            <div class="card card-soft">
                <div class="card-body">
                    ...
                    <div class="small-muted mb-3">Gunakan menu Template Cepat jika ingin mengisi qty otomatis dari paket
...
<script>
    ...
    function validateBeforeConfirm() {
        ...
        if (state.invalidField) {
            showError('Qty hanya boleh berupa angka bulat 0 atau lebih.');
            return null;
        }

        if (state.totalItems <= 0) {
            showError('Minimal satu qty harus diisi.');
            return null;
        }
