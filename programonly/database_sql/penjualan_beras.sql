...
(1, 'BRS-005', 'Beras Premium 5 Kg', 5.00, 1, NOW(), NOW()),
(2, 'BRS-010', 'Beras Premium 10 Kg', 10.00, 1, NOW(), NOW()),
(3, 'BRS-025', 'Beras Premium 25 Kg', 25.00, 1, NOW(), NOW());

INSERT INTO product_prices (id, product_id, price, effective_date, is_current, updated_by, created_at, updated_at) VALUES
(1, 1, 78000.00, CURDATE(), 1, 1, NOW(), NOW()),
(2, 2, 150000.00, CURDATE(), 1, 1, NOW(), NOW()),
(3, 3, 360000.00, CURDATE(), 1, 1, NOW(), NOW());
...
(1, 1, 'Beras Premium 5 Kg', 5.00, 78000.00, 2, 156000.00, 10.00),
(1, 2, 'Beras Premium 10 Kg', 10.00, 150000.00, 1, 150000.00, 10.00),
(2, 1, 'Beras Premium 5 Kg', 5.00, 78000.00, 1, 78000.00, 5.00),
(2, 3, 'Beras Premium 25 Kg', 25.00, 360000.00, 1, 360000.00, 25.00),
(3, 1, 'Beras Premium 5 Kg', 5.00, 78000.00, 1, 78000.00, 5.00),
(3, 2, 'Beras Premium 10 Kg', 10.00, 150000.00, 1, 150000.00, 10.00);
