                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <div class="small-muted">Ringkasan total penjualan 7 hari terakhir sampai transaksi terbaru.</div>
                        </div>
                    </div>
                    <canvas id="dailySalesChart" height="120"></canvas>
                    <div class="small-muted mt-2">Skala nominal otomatis mengikuti nilai penjualan terbesar, bukan batas maksimum transaksi.</div>
                </div>
            </div>
        </div>
        <div class="col-xl-5">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <div class="small-muted">Perbandingan 6 bulan terakhir sampai bulan transaksi terbaru.</div>
                        </div>
                    </div>
                    <canvas id="monthlySalesChart" height="120"></canvas>
                    <div class="small-muted mt-2">Tidak ada batas tahun khusus; bulan mengikuti tanggal transaksi yang tersimpan.</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <a href="<?= site_url('/sales/create') ?>" class="text-decoration-none">
                <div class="card card-soft h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="page-subtitle mb-0">Input transaksi manual dengan jumlah beras 5 kg, 10 kg, dan 25 kg.</p>
                    </div>
                </div>
            </a>
        </div>
