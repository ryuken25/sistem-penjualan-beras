    ...
    <div class="col-xl-7">
        <div class="card card-soft h-100">
            <div class="card-body">
                ...
                <div class="small-muted mb-3">Ringkasan 14 hari terakhir sampai transaksi terbaru. Skala nominal otomatis, bukan batas maksimum transaksi.</div>
    ...
    <div class="col-xl-5">
        <div class="card card-soft h-100">
            <div class="card-body">
                ...
                <div class="small-muted mb-3">Perbandingan 6 bulan terakhir sampai bulan transaksi terbaru; tidak ada batas tahun khusus.</div>
